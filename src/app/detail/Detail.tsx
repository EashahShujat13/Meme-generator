...
return (
    <div className="w-full">
        ...
        <div>
        <div className="text-2xl font-bold p-4">{data.name}</div>
        <div>
    ...
    <div className="flex justify-center gap-2 align-middle mt-10 flex-wrap contain ">
        <div>
        <input
            className="p-2 border-2 border-gray-300 rounded-lg hover:border-black focus:outline-none focus:ring-2 focus:ring-black "
